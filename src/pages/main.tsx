            ...
            <Space direction="vertical" size={"middle"}>
                <div className="about-on-main">
                    <p>Мы рады приветствовать вас на официальном сайте проекта Antidict. Наш проект посвящён
                        ...
                        изначально обученный для определения этих типов слов в корпусе ГИКРЯ. Для распознавания
                        англоязычных заимствований наш классификатор был обучен на словаре Дьякова. Для классификации
                        эрративов и экспрессивных слов нами были собраны отдельные датасеты. Эрративы рассматриваются
                        нами как подкласс слов с экспрессивной окраской, которые также включают в себя слова с
                        экспрессивными аффиксами и мат. Проект представлен студентами магистратуры школы лингвистики
                        Национального исследовательского университета «Высшая школа экономики». Разработка проекта
                        проходила в 2019-2020 годах. В данный момент над совершенствованием Antidict трудятся 5 человек:
                        Антон Вахранёв, Алексей Доркин, Ирина Дьячкова, Лидия Остякова и Владислава Смирнова. Надеемся,
                        наш проект будет полезен для вас! </p>
                    <h2  style={{margin: '0 auto', textAlign: 'center'}}>Как пользоваться Antidict? </ h2>
                    <p>Чтобы проанализировать текст, вставьте его в пустое поле ниже и нажмите на кнопку «Разобрать». В
                        качестве результата работы модели вы увидите размеченный текст, списки распределенных по трем
                        категориям слов и коэффициенты наличия в тексте слов из трех категорий. </p>
                    <p>Этот уникальный проект может быть полезен в различных лингвистических экспериментах, в которых
                        необходима автоматическая разметка текстов по данным трем классам. Подробнее ознакомиться с
                        проектом Antidict можно в разделе <a href="/about">"О проекте"</a>. </p>
